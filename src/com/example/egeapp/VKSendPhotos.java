			...
			switch (requestCode) {
				...
				case CODE_SWITCH_USER : {
					...
					if (user_id == null || user_id.equals(""))
						Toast.makeText(this, "“екущий пользователь не выбран",
								Toast.LENGTH_LONG).show();
					else
						Toast.makeText(this,
								"ID текущего пользовател€: " + user_id,
								Toast.LENGTH_LONG).show();
					break;
				}
				...
				case REQUEST_CODE_CAMERA : {
					...
					// точно на быстрой пам€ти устройства. ничего не повиснет.					
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.button_send_photo : {
				...
				//“ут у компил€тора было солнечное затмение. по другому не работало
				...
				if (friends2send == null || friends2send.equals("")) {
					Toast.makeText(this,
							"Ќе выбрано пользователей дл€ отправки фото",
							Toast.LENGTH_LONG).show();
					return;
				}
